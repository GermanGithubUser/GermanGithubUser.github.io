...
function solveSudoku() {
    let gridString = getCellValues().join('');
    // need to replace because that's how sudoku.js implemented it
    let solution = sudoku.solve(gridString.replaceAll('0', '.'));
    checkSolvable();
    if(solution) {
...
// not necessary but maybe best practice? - https://developer.mozilla.org/en-US/docs/Web/API/Document/DOMContentLoaded_event
